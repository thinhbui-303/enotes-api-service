...
public class SwaggerConfig {
	...
	public OpenAPI openAPI() {
		...
		info.setContact(
				new Contact().email("dauphongdz@gmail.com").name("ThinhMiner").url("http://dauphongdz.com/contact"));
		info.setLicense(new License().name("Enotes 1.0").url("http://dauphongdz.com"));
